...
const BAMSChat = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      const res = await fetch("http://localhost:4000/api/chat", {
        ...
        body: JSON.stringify({ message: input, type: "BAMS" }),
      });
  ...
  return (
    <div className="chat-page bams-theme">
      <div className="chat-window">
        <h2 className="chat-title">🌿 Ayurveda Health Assistant</h2>
